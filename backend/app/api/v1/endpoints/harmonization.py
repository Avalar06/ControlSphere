...
def create_crosswalk(
    ...
    """Create a global normative framework crosswalk mapping (ADMIN only)."""
...
def delete_crosswalk(
    ...
    """Delete a global normative framework crosswalk mapping (ADMIN only)."""
...
def execute_harmonization_evaluation(
    ...
    """Trigger deterministic multi-framework evaluation and snapshot creation."""
